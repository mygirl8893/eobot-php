...
class MockEobotResponder
{
    ...
    private static $coinValues = array(
        ...
        Client::COIN_STELLAR                   => 0.00220185,
    ...
    private static $coinBalances = array(
        1234  => array(
            ...
            Client::COIN_STELLAR               => 0.06467642,
            Client::COIN_STORJCOIN_X           => 0.02639744,
            Client::EO_CLOUD_SHA256_CONTRACT   => 20.00019989,
        ...
        12345 => array(
            ...
            Client::COIN_STELLAR               => 0.06467642,
            Client::COIN_STORJCOIN_X           => 0.02639744,
            Client::EO_CLOUD_SHA256_CONTRACT   => 20.00017989,
    ...
    private static $depositWallets = array(
        1234 => array(
            ...
            Client::COIN_STELLAR      => '1234567890abcdefghijklmnopqrstuvwx',
    ...
    private static $miningModes = array(
        ...
        3456 => Client::EO_CLOUD_SHA256_CONTRACT,
